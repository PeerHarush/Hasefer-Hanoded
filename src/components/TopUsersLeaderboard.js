...
const TopUsersLeaderboard = () => {
  ...
  // כדי שמקום 1 יהיה באמצע, נמיין: 2,1,3
  const orderedUsers = [
    topUsers[1], // מקום 2 שמאל
    topUsers[0], // מקום 1 מרכז
    topUsers[2], // מקום 3 ימין
  ...
  const defaultAvatars = {
    1: '/pictures/פרופיללללללל.jpg',
    2: '/pictures/Screenshot 2025-06-08 200746.png',
    3: '/pictures/Screenshot 2025-06-09 111123.png',
  };
  ...
  return (
    <PodiumWrapper>
      {orderedUsers.map((user, idx) => {
        ...
        const imageSrc = defaultAvatars[position]; // תמונה זמנית בלבד
